      ...
      <div>
          {profile ? (
            ...
            <>
              ...
              <button id="sign-in" onClick={() => login()}>Sign in to LOTION with&nbsp;&nbsp;<img src="https://companieslogo.com/img/orig/GOOG-0ed88f7c.png?t=1633218227" alt="Google logo" height="20px" width="20px" /></button>
            </>
          )}
      </div>
  );
